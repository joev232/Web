...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.ejemplo.tablasDTO.Persona, java.util.List,  com.ejemplo.tablasDTO.Perro" %>
...
lista_personas_perros.add(new Persona(30, "Tamara",new Perro("Yako", "Golden")));
